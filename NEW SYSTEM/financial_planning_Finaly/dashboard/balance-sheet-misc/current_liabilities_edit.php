...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Balance Sheet</li>
		 <li class="breadcrumb-item">Edit Current Liabilities</li>
      </ol>
	...
	<tbody>
	<form action="current_liabilities_edit_proccess.php" method="post">
		<tr>
			<td>Accounts payable</td>
			<td><input class="form-control" type="number" name="accounts_payable" value="<?php echo $accounts_payable ?>"></td>
		</tr>
		<tr>
			<td>Accrued expenses</td>
			<td><input class="form-control" type="number" name="accrued_expenses" value="<?php echo $accrued_expenses ?>"></td>
		<tr>
		<tr>
			<td>Notes payable</td>
			<td><input class="form-control" type="number" name="notes_payable" value="<?php echo $notes_payable ?>"></td>
		<tr>
		<tr>
			<td>Capital leases</td>
			<td><input class="form-control" type="number" name="capital_leases" value="<?php echo $capital_leases ?>"></td>
		<tr>
		<tr>
			<td>Other current liabilities</td>
			<td><input class="form-control" type="number" name="ocurrent_liab" value="<?php echo $ocurrent_liab ?>"></td>
		<tr>
