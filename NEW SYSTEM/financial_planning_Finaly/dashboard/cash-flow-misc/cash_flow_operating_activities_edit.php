...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Cash flow</li>
		 <li class="breadcrumb-item">Edit Operating Activities</li>
      </ol>
	...
	<tbody>
	<form action="cash_flow_operating_activities_edit_proccess.php" method="post">
		<tr>
			<td>Amortization</td>
			<td><input class="form-control" type="number" name="amortizationvalue" value="<?php echo $amortizationvalue ?>"></td>
		</tr>
		<tr>
			<td>Other Liabilities</td>
			<td><input class="form-control" type="number" name="otherliabilitiesvalue" value="<?php echo $otherliabilitiesvalue ?>"></td>
		<tr>
		<tr>
			<td>Other operating cash flow items</td>
			<td><input class="form-control" type="number" name="othercashflow" value="<?php echo $othercashflow ?>"></td>
		<tr>
