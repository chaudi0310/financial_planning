		...
		var myBarChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: [<?= round($ending_cash_balance['year1'], 2) ?>,
					<?= round($ending_cash_balance['year2'], 2) ?>,
					<?= round($ending_cash_balance['year3'], 2) ?>,
					<?= round($ending_cash_balance['year4'], 2) ?>,
					<?= round($ending_cash_balance['year5'], 2) ?>],
				}],
			},
			options: {
				scales: {
