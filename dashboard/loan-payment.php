...
<head>
  ...
  <title>Loan Payment Calculator - Financial Planning System</title>
  <!-- Bootstrap core CSS-->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
		...
		<li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Loan Payment Calculator">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Loan Payment Calculator</li>
      </ol>
     <?php include_once 'loan-payment-misc/loan-payment-calc.php'; ?> 
