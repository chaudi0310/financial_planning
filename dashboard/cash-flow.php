...
if(isset($_SESSION['action'])){
	if($_SESSION['action'] == 'balancesheet'){
...
if(isset($_SESSION['action'])){
	if($_SESSION['action'] == 'modelinputs'){
		unset($_SESSION['action'])
		?>
			<script>
...
<head>
  ...
  <title>Cash Flow - Financial Planning System</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php include_once 'cash-flow-misc/cash_flow_operating_activities.php'; ?>
	  <br>
	  <?php include_once 'cash-flow-misc/cash_flow_investing_activities.php'; ?>
	  <br>
	  <?php include_once 'cash-flow-misc/cash_flow_financing_activities.php'; ?>
	  <br>
	  <?php include_once 'cash-flow-misc/cash_flow.php'; ?>
